    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שוטגן כביסה פלוגה א משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'db7ecabb-d306-4aae-bfc6-8b0878d1a556',
                    name: data.name || '',
                    email: data.email || '',
